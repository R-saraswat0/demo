  ...
  return (
    <div style={{ background: 'linear-gradient(135deg, #e3eafc 0%, #f8fafc 100%)', minHeight: '100vh', width: '100vw', padding: '0', margin: '0', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '70vh', padding: '60px 0 0 0', position: 'relative' }}>
        ...
        <Link to="/destination" style={{ padding: '16px 44px', background: 'linear-gradient(90deg, #1E90FF 0%, #2ECC71 100%)', color: 'white', borderRadius: '30px', fontWeight: 700, fontSize: '1.18rem', textDecoration: 'none', boxShadow: '0 4px 16px #1e90ff22', transition: 'background 0.3s', marginBottom: '40px', letterSpacing: '0.5px' }}>
      ...
      <div style={{ width: '100%', maxWidth: '900px', margin: '0 auto', marginBottom: '60px', textAlign: 'center', background: 'linear-gradient(90deg, #1E90FF 0%, #2ECC71 100%)', borderRadius: '18px', padding: '38px 0', color: 'white', boxShadow: '0 4px 16px #1e90ff22' }}>
        ...
        <Link to="/auth" style={{ padding: '14px 38px', background: 'white', color: '#1E90FF', borderRadius: '30px', fontWeight: 700, fontSize: '1.15rem', textDecoration: 'none', boxShadow: '0 4px 16px #1e90ff22', transition: 'background 0.3s', letterSpacing: '0.5px' }}>Get Started</Link>
      </div>
